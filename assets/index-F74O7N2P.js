...
`).forEach((c,l)=>a.fillText(c,64,76+l*20));const o=new q(new Ke(.7,.7),new $e({map:new St(r),transparent:!0}));o.rotation.x=-Math.PI/2,o.position.set(e,.02,t),this.scene.add(o)}_addAmExSkeleton(){const e=new Ue({color:13945256,roughness:.8}),t=new Ue({color:13209,roughness:.5}),n=new st,i=new q(new _e(.6,.7,.25),t);i.position.y=1.15,n.add(i);const r=new q(new _e(.36,.38,.3),e);r.position.y=1.66,n.add(r);const a=new $e({color:16711680});[[-.09,0],[.09,0]].forEach(([c])=>{const l=new q(new _e(.1,.1,.05),a);l.position.set(c,1.68,.16),n.add(l)}),[-.14,.14].forEach(c=>{const l=new q(new _e(.12,.8,.12),e);l.position.set(c,.4,0),n.add(l)});const o=new q(new _e(.22,.18,.08),t);o.position.set(.45,.95,0),n.add(o),n.position.set(-1.5,0,-77),n.rotation.y=.4,this.scene.add(n),this._suitSkeleton=n,this._t=0}update(e){this._suitSkeleton&&(this._t+=e,this._suitSkeleton.rotation.y=.4+Math.sin(this._t*.5)*.2)}}const j0=["Rust","LLM Agents","Apache Iceberg","Real-time ML","Kubernetes"],$0=["AWS Solutions Architect","Databricks Certified DE","Google Cloud DE"],Z0=["Staff Data Engineer","ML Platform Engineer","Open Source contributor"];class J0{constructor(e){this.experience=e,this.scene=e.scene,this._build()}_build(){this._addPanel("CURRENTLY LEARNING",j0,"#20e840",-2.3,-85,"left"),this._addPanel("CERTIFICATIONS",$0,"#44aaff",2.3,-85,"right"),this._addGoalBanner(-86.5)}_addPanel(e,t,n,i,r,a){const o=document.createElement("canvas");o.width=256,o.height=400;const c=o.getContext("2d");c.fillStyle="#060a06",c.fillRect(0,0,256,400),c.strokeStyle=n,c.lineWidth=2,c.strokeRect(8,8,240,384),c.font='bold 20px "Courier New"',c.fillStyle=n,c.textAlign="center",c.fillText(e,128,42),c.fillStyle=n,c.fillRect(20,52,216,1),c.font='17px "Courier New"',c.fillStyle="#a0c8a0",t.forEach((d,f)=>c.fillText("▸ "+d,128,88+f*54));const l=new st,u=new q(new _e(.08,1.5,1.2),new Ue({color:659464,roughness:1}));l.add(u);const h=new q(new Ke(1.14,1.42),new $e({map:new St(o),transparent:!0,side:Ft}));h.position.set(.05,0,0),l.add(h),l.position.set(i,1.5,r),l.rotation.y=a==="left"?-Math.PI/2:Math.PI/2,this.scene.add(l)}_addGoalBanner(e){const t=document.createElement("canvas");t.width=1024,t.height=80;const n=t.getContext("2d");n.clearRect(0,0,1024,80),n.font='bold 20px "Courier New"',n.fillStyle="#20e840",n.textAlign="center",n.fillText("TARGET ROLES:  "+Z0.join("  ·  "),512,50);const i=new q(new Ke(7,.5),new $e({map:new St(t),transparent:!0}));i.position.set(0,3.2,e),this.scene.add(i)}update(){}}class Q0{constructor(e){this.experience=e,this.scene=e.scene,this._fadeIn=0,this._triggered=!1,this._build()}_build(){const e=new st,t=new Ue({color:858922,roughness:.9}),n=new Ue({color:660768,roughness:1}),i=new q(new Ke(12,16),n);i.rotation.x=-Math.PI/2,i.position.set(0,0,-90),e.add(i);const r=new q(new Ke(12,7),t);r.position.set(0,3.5,-99),e.add(r);const a=new q(new Ke(16,7),t);a.rotation.y=Math.PI/2,a.position.set(-6,3.5,-90),e.add(a);const o=new q(new Ke(16,7),t);o.rotation.y=-Math.PI/2,o.position.set(6,3.5,-90),e.add(o);const c=new q(new Ke(12,16),t);c.rotation.x=Math.PI/2,c.position.set(0,7,-90),e.add(c),this.blueLight=new Cn(43775,0,25),this.blueLight.position.set(0,5,-92),e.add(this.blueLight),this.chamberAmbient=new Cn(13158,0,35),this.chamberAmbient.position.set(0,3,-84),e.add(this.chamberAmbient),this._addWallText(e,"YOU MADE IT THROUGH THE PIPELINE.",-98.5,5.8,26,"#00aaff"),this._addWallText(e,"─────────────────────────────────",-98.5,5,18,"#1a4a6a"),this._addWallText(e,"✉  shanmukhsaivenkatmedisetti@gmail.com",-98.5,4.2,18,"#e8a020"),this._addWallText(e,"◈  github.com/Shanmukha0505",-98.5,3.4,20,"#4a9eff"),this._addWallText(e,"◉  linkedin.com/in/ShanmukhaSai",-98.5,2.6,20,"#0099cc"),this._addWallText(e,"MS Data Science · American Express · Denver CO",-98.5,1.6,15,"#4a4a6a");const l=new $e({color:17544});[-.6,.6].forEach(u=>{const h=new q(new Ke(.07,18),l);h.rotation.x=-Math.PI/2,h.position.set(u,.01,-88),e.add(h)}),this._buildParticles(e),this.scene.add(e),this.group=e}_addWallText(e,t,n,i,r,a){const o=document.createElement("canvas");o.width=1024,o.height=96;const c=o.getContext("2d");c.clearRect(0,0,1024,96),c.font=`bold ${r}px "Courier New", monospace`,c.fillStyle=a,c.textAlign="center",c.fillText(t,512,64);const l=new q(new Ke(9,.85),new $e({map:new St(o),transparent:!0}));l.position.set(0,i,n),e.add(l)}_buildParticles(e){const n=new Rt,i=new Float32Array(150*3);for(let r=0;r<150;r++)i[r*3]=(Math.random()-.5)*11,i[r*3+1]=Math.random()*6,i[r*3+2]=-80-Math.random()*18;n.setAttribute("position",new Mt(i,3)),this.particles=new xo(n,new vr({color:4500223,size:.05,transparent:!0,opacity:.8})),this._particlePos=i,e.add(this.particles)}update(e){const t=this.experience.player;if(!t)return;const n=t.body.position.z;if(n<-78){this._fadeIn=Math.min(1,this._fadeIn+e*.5);const i=this.experience.time.elapsed;this.blueLight.intensity=this._fadeIn*(15+Math.sin(i*1.4)*2),this.chamberAmbient.intensity=this._fadeIn*7}if(n<-84&&!this._triggered&&(this._triggered=!0,console.log("💙 You made it through the pipeline.")),this.particles&&this._fadeIn>0){for(let i=0;i<this._particlePos.length/3;i++)this._particlePos[i*3+1]+=e*.1,this._particlePos[i*3+1]>6.5&&(this._particlePos[i*3+1]=.1);this.particles.geometry.attributes.position.needsUpdate=!0}}}class ex{constructor(e){this._exp=e,this.insideTunnel=!1,this.graveyard=new U0(e),this.tunnelEntrance=new N0(e),this.tunnel=new F0(e),this.nameWall=new O0(e),this.markers=[new as(e,{z:-14,chapter:"CHAPTER I",title:"WHO I AM",color:12632256}),new as(e,{z:-25,chapter:"CHAPTER II",title:"SKILLS",color:15245344}),new as(e,{z:-53,chapter:"CHAPTER III",title:"PROJECTS",color:10040319}),new as(e,{z:-73,chapter:"CHAPTER IV",title:"EXPERIENCE",color:13386752}),new as(e,{z:-84,chapter:"CHAPTER V",title:"GOALS & VISION",color:2156608})],this.whoIAm=new B0(e),this.skeletons=new G0(e),this.skillWalls=new W0(e),this.coalCarts=new q0(e),this.expZone=new K0(e),this.goals=new J0(e),this.contact=new Q0(e)}getFloorObjects(){return this.graveyard.floorMeshes}update(e){var n;this.graveyard.update(e),this.tunnelEntrance.update(e),this.tunnel.update(e),this.nameWall.update(e),this.markers.forEach(i=>i.update(e)),this.whoIAm.update(e),this.skeletons.update(e),this.skillWalls.update(e),this.coalCarts.update(e),this.expZone.update(e),this.goals.update(e),this.contact.update(e);const t=(n=this._exp)==null?void 0:n.player;t&&!this.insideTunnel&&this.tunnelEntrance.checkTrigger(t.body.position,()=>this._enterTunnel())}_enterTunnel(){this.insideTunnel=!0;const e=document.createElement("div");e.style.cssText=`
